...
// Adapted defaults: no demo label, electric-blue accent to match the site
// palette, "rings" mode (calmer than the sniper-crosshair default), and a
// prefers-reduced-motion guard — the original only used GSAP tweens, which
// aren't covered by the site's global CSS reduced-motion override.
"use client";
...
export default function MouseEffects({
    ...
    }, [interactionMode, effectSize, reducedMotion]);
