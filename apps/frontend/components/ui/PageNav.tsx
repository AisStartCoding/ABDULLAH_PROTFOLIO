    ...
    <nav aria-label="Page navigation">
      {prevHref && (
        <Link
          ...
          className="cursor-target fixed left-4 top-1/2 z-40 inline-flex h-11 min-w-11 -translate-y-1/2 items-center justify-center gap-2 rounded-md border border-slate-700/60 bg-slate-950/90 px-3 text-sm font-semibold text-slate-300 shadow-lg shadow-black/30 backdrop-blur-md transition-colors hover:border-green-500/40 hover:text-green-400 sm:px-4"
        >
      ...
      {nextHref && (
        <Link
          ...
          className="cursor-target fixed right-4 top-1/2 z-40 inline-flex h-11 min-w-11 -translate-y-1/2 items-center justify-center gap-2 rounded-md border border-slate-700/60 bg-slate-950/90 px-3 text-sm font-semibold text-slate-300 shadow-lg shadow-black/30 backdrop-blur-md transition-colors hover:border-green-500/40 hover:text-green-400 sm:px-4"
        >
